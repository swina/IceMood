...
|
*/
$config['encryption_key'] = '1sk7hiwk';
...
/*
|--------------------------------------------------------------------------
| ICECAST / ICEGENERATOR
|--------------------------------------------------------------------------
|
| Setting of icecast paths
|
|
| Comma-separated:	'10.0.1.200,192.168.5.0/24'
| Array:		array('10.0.1.200', '192.168.5.0/24')
...
//streaming URL and status json settings
$config['streaming'] = 'http://stream.italianmood.net:8080';
$config['streaming_json'] = 'status-json.xsl';

//server user with permissions to start and kill services
$config['sudo'] = '/usr/bin/sudo -u root';

//icecast path , config xml and log
...
//icegenerator path and config
$config['icegenerator'] = 1; //0 = icegenerator not installed
$config['icegen_path'] = '/usr/local/bin/icegenerator';
$config['icegen_cfg'] = '/root/icegenerator/swina.cfg';
$config['icegen_log'] = '/root/icegenerator/radio.log';

//audio storage
$config['audio_path'] = '/home/admin/audio/';
$config['playlist'] = 'songlist.m3u';
$config['id3_genre'] = array("Blues","ClassicRock","Country","Dance","Disco","Funk","Grunge","HipHop","Jazz",
